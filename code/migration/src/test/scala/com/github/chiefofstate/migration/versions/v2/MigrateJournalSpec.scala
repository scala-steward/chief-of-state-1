...
import com.github.chiefofstate.migration.{ BaseSpec, DbUtil, JdbcConfig, SchemasUtil }
...
class MigrateJournalSpec extends BaseSpec with ForAllTestContainer {
  ...
  "MigrateJournal" should {
    ...
    "migrate legacy journal data into the new journal" in {
      ...
      manifests.head shouldBe "com.github.chiefofstate.protobuf.v1.persistence.EventWrapper"
