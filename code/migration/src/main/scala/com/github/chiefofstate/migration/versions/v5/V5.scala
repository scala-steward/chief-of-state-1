...
package com.github.chiefofstate.migration.versions.v5

import akka.Done
import akka.actor.typed.ActorSystem
import akka.stream.scaladsl.Source
import com.github.chiefofstate.migration.{ SchemasUtil, Version }
import com.github.chiefofstate.migration.versions.v5.V5.log
import com.github.chiefofstate.protobuf.plugins.persistedheaders.v1.headers.{
  Header => LegacyHeader,
...
object V5 {
  ...
  def migrateJournal(dbConfig: DatabaseConfig[JdbcProfile])(implicit system: ActorSystem[_]): Unit = {
    ...
    val pipeline: Future[Done] = Source
      ...
      .map { case (ordering, eventWrapper) =>
